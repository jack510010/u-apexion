...
$sql = sprintf("SELECT * FROM forum_article LEFT JOIN forum_category ON forum_category.cat_sid=forum_article.art_category_sid WHERE art_category_sid=1 ORDER BY forum_article.sid DESC LIMIT %s, %s", ($page-1)*$perPage, $perPage);
